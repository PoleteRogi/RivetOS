...
def init(m):
    ...
    originalHomeButtonImage = pygame.image.load("./assets/HomeButton.png").convert_alpha()
    homeButtonImage = pygame.transform.scale(originalHomeButtonImage, (80, 40)).convert_alpha()

def render(m):
    global homeButtonImage
    actionBarSurface = pygame.Surface((400, 800), pygame.SRCALPHA)

    pygame.draw.rect(actionBarSurface, (0, 0, 0), (0, 800 - 50 + 50 * (1 - m.appSize), 400, 50), 400)
    ...
    if x+80 > mouse[0] > x and y+40 > mouse[1] > y:
        ...
        homeButtonImage = pygame.transform.scale(originalHomeButtonImage, (85, 42.5)).convert_alpha()
